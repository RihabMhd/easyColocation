                ...
                @foreach ($colocations as $colocation)
                    <div class="relative bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:border-indigo-500 transition-all">
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <span class="px-2 py-1 text-xs font-medium rounded-md bg-green-50 text-green-700 ring-1 ring-inset ring-green-600/20">
            ...
            <form id="editForm" method="POST" class="p-6">
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <button type="button" onclick="closeModal('editModal')"
                        class="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-50 rounded-lg hover:bg-gray-100">Cancel</button>
                    <button type="submit"
                        class="px-4 py-2 text-sm font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700">Save Changes</button>
                </div>
            </form>
        </div>
    </div>
